...
def test_examples_cy8ckit_028_epd_driver(env, extra_data):
    app_name = 'cy8ckit_028_epd_driver'
    dut = env.get_dut(app_name, 'examples/get-started/cy8ckit_028_epd_driver')
    dut.start_app()
...
if __name__ == '__main__':
    test_examples_cy8ckit_028_epd_driver()
