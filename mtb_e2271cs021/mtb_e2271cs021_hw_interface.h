...
esp_err_t MTB_E2271CS021_InitDriver(const mtb_e2271cs021_pins_t* pins, cyhal_spi_t* spi_inst);
esp_err_t MTB_E2271CS021_WriteSPI(uint8_t data);
esp_err_t MTB_E2271CS021_ReadSPI(uint8_t* data);
esp_err_t MTB_E2271CS021_WriteReadSPI(uint8_t writeData, uint8_t* readData);
esp_err_t MTB_E2271CS021_WriteSPIBuffer(uint8_t* data, uint16_t dataLength);
