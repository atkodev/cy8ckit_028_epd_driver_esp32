...
typedef struct
{
    gpio_num_t spi_mosi;  /**< SPI MOSI pin */
    gpio_num_t spi_miso;  /**< SPI MISO pin */
    gpio_num_t spi_sclk;  /**< SPI SCLK pin */
    gpio_num_t spi_cs;    /**< SPI CS pin */
    gpio_num_t reset;     /**< GPIO Reset pin */
    gpio_num_t busy;      /**< GPIO Busy pin */
    gpio_num_t discharge; /**< GPIO Discharge pin */
    gpio_num_t enable;    /**< GPIO Enable pin */
    gpio_num_t border;    /**< GPIO Border pin */
    gpio_num_t io_enable; /**< GPIO IO Enable pin */
