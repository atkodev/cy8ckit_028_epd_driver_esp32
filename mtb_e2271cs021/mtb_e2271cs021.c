...
// mtb_e2271cs021_init
//--------------------------------------------------------------------------------------------------
esp_err_t mtb_e2271cs021_init(const mtb_e2271cs021_pins_t* pins, cyhal_spi_t* spi)
{

    assert(pins != NULL);
    assert(spi != NULL);

    esp_err_t rslt = MTB_E2271CS021_InitDriver(pins, spi);
...
//--------------------------------------------------------------------------------------------------
esp_err_t mtb_e2271cs021_power(bool power)
{
...
//--------------------------------------------------------------------------------------------------
esp_err_t mtb_e2271cs021_clear(bool background, bool powerCycle)
{
    esp_err_t result = CY_RSLT_SUCCESS;
...
//--------------------------------------------------------------------------------------------------
esp_err_t mtb_e2271cs021_show_frame(uint8_t* prevFrame, uint8_t* newFrame,
